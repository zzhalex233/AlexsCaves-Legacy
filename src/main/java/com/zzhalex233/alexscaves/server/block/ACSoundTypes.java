...
public class ACSoundTypes {
    public static final SoundType AMBER = new SoundType(1.0F, 1.0F, ACSoundRegistry.AMBER_BREAK, ACSoundRegistry.AMBER_STEP, ACSoundRegistry.AMBER_PLACE, ACSoundRegistry.AMBER_BREAKING, ACSoundRegistry.AMBER_STEP);
    public static final SoundType AMBER_MONOLITH = new SoundType(1.0F, 1.0F, ACSoundRegistry.AMBER_MONOLITH_PLACE, ACSoundRegistry.AMBER_STEP, ACSoundRegistry.AMBER_MONOLITH_PLACE, ACSoundRegistry.AMBER_BREAKING, ACSoundRegistry.AMBER_STEP);
    ...
    public static final SoundType SULFUR = new SoundType(1.0F, 1.0F, ACSoundRegistry.SULFUR_BREAK, ACSoundRegistry.SULFUR_STEP, ACSoundRegistry.SULFUR_PLACE, ACSoundRegistry.SULFUR_BREAKING, ACSoundRegistry.SULFUR_STEP);
    public static final SoundType NEODYMIUM = new SoundType(1.0F, 1.0F, ACSoundRegistry.NEODYMIUM_BREAK, ACSoundRegistry.NEODYMIUM_STEP, ACSoundRegistry.NEODYMIUM_PLACE, ACSoundRegistry.NEODYMIUM_BREAKING, ACSoundRegistry.NEODYMIUM_STEP);
    ...
    public static final SoundType PEWEN_BRANCH = new SoundType(1.0F, 1.0F, ACSoundRegistry.PEWEN_BRANCH_BREAK, net.minecraft.init.SoundEvents.BLOCK_GRASS_STEP, ACSoundRegistry.PEWEN_BRANCH_BREAK, ACSoundRegistry.PEWEN_BRANCH_BREAK, net.minecraft.init.SoundEvents.BLOCK_GRASS_STEP);
