...
public class LimestoneSpearItem extends Item {
    ...
    public void onPlayerStoppedUsing(ItemStack stack, World worldIn, EntityLivingBase entityLiving, int timeLeft) {
        ...
        if (!worldIn.isRemote) {
            LimestoneSpearEntity spear = new LimestoneSpearEntity(worldIn, player);
            ...
            worldIn.playSound(null, spear.posX, spear.posY, spear.posZ, ACSoundRegistry.LIMESTONE_SPEAR_THROW, SoundCategory.PLAYERS, 1.0F, 1.0F);
